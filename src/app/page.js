      ...
      <div className='relative container mx-auto bg-white/0 z-10'>
        <section className='relative flex justify-center items-center text-4xl uppercase flex-col font-light min-h-screen space-y-10'>
          ...
          <div className='text-2xl text-center space-y-1'>
            ...
            <div>
              초기 부담 없이 아이디어를 현실로, 혁신적인 구독형 OEM/ODM으로 시장 선두까지 함께하세요.            </div>
          </div>
        ...
        <section className='flex justify-center items-center text-4xl uppercase  flex-col font-light min-h-screen space-y-10'>
          ...
          <div className='text-xl text-center'>
            키오스크는 단순한 디지털 기기를 넘어섰습니다. 이제 고객과의 접점을 혁신하고, 운영 효율을 극대화하며, 새로운 비즈니스 가치를 창출하는 핵심 솔루션입니다. 직관적인 터치스크린 하나로 복잡한 업무를 처리하고, 24시간 고객을 응대하며, 데이터를 통해 비즈니스를 성장시키는 스마트한 미래. Quiosco는 바로 그 키오스크 기술로 당신의 독창적인 아이디어를 현실로 만들어줄 비즈니스 파트너입니다.
          </div>
        ...
        <section className='flex justify-center items-center min-h-screen hidden'>
